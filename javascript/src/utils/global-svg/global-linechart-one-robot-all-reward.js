...
export default class GlobalLineChartOneRobotAllReward extends GlobalLineChartSVG {
    ...
    processData() {
        ...
        // for (const key of globalVariables.rewardLabels) {
        ...
        for (const key of movementContainer.getRewardLabels()) {
            yMin = Math.min(yMin, mins[key]);
            yMax = Math.max(yMax, maxs[key]);
        }
