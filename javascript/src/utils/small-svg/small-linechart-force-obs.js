...
export default class SmallLineChartObsForce extends SmallLineChartSVG {
    ...
    initMovement() {
        ...
        for (const rbtnum of movementContainer.robotNums) {
            const movement = movementContainer.getJointForce(rbtnum);
    ...
    drawByX() {
        ...
        if (this.currentMov !== null) {
            const mov = movementContainer.getJointForce(this.currentMov);
