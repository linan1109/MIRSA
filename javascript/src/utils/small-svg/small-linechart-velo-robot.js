...
export default class SmallLineChartRobotVelo extends SmallLineChartSVG {

    constructor(robotNum, offsetWidth) {
        super(offsetWidth);
        this.movement = movementContainer.getVelocity(robotNum);
        ...
        if (this.movement !== null) {
            ...
            if (this.current >= 0 && this.current < this.movement.length) {
                ...
                if (globalVariables.lockBrush) {
                    ...
                    x1 = Math.min(this.movement.length, x1);
                }
