...
export default class SmallLineChartOneRewardAllRobot extends SmallLineChartSVG {

    constructor(rewardName, offsetWidth) {
        super(offsetWidth);
    ...
    drawByX() {
        ...
        if (this.currentMov !== null) {
            const mov = movementContainer.getReward(this.currentMov);
            const textY = parseFloat(
                mov[this.current][this.rewardName],
            );
