...
export default class SmallLineChartObsVelo extends SmallLineChartSVG {
    ...
    initMovement() {
        ...
        for (const rbtnum of movementContainer.robotNums) {
            const movement = movementContainer.getVelocity(rbtnum);
    ...
    drawByX() {
        ...
        if (this.currentMov !== null) {
            const mov = movementContainer.getVelocity(this.currentMov);
